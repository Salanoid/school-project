    ...
    <div class="content">
      ...
      <?php
        ...
        foreach ($contacts as $contact) {
          echo '<hr>';
          echo "<b>Name:</b> " . $contact['name'] . '<br>';
          echo "<b>Question:</b> " . $contact['question'] . '<br>';
        }
        echo '<hr>';
      ?>
    ...
    <?php
      if(isset($_POST["submit"])){
        $sql = "INSERT INTO contact (name, question)
                ...
                if ($conn->query($sql)) {
                  echo "<script type= 'text/javascript'>window.location.replace('contact.php');alert('Data successfully Inserted.');</script>";
                }
                else{
